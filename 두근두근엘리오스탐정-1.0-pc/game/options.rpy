...
define config.name = _("두근두근엘리오스탐정")
...
define config.sample_sound = "audio/GetItem_Unique.wav"
...
define config.save_directory = "dokidoki-1583905091"
